...
1. 重回帰分析の評価
   ...
   $$
   $$
   (2) E(\widehat\beta - \beta)(\widehat\beta - \beta') = E(Z_{\epsilon}(X_{\epsilon})'
   $$
   $$
   = ZE(\epsilon \epsilon')Z'
   $$
   $$
   = Z\sigma^{2}EZ'
   $$
   ...
   = \sigma^{2}(XX)^{-1}
   $$
   したがって$\widehat\beta~N(\beta,\sigma^{2}(X'X)^{-1})$
      
   1. 決定係数
   $$
   (3) \epsilon ' \epsilon = (Y - X\widehat\beta)
   $$
   $$
   = Y'Y - \widehat\beta X'Y - Y'X\widehat\beta + \widehat\beta ' X \widehat \beta
   $$
   $$
   = Y'Y - \widehat\beta ' X\widehat\beta
   $$
   $$
   (4) Y'Y = \widehat\beta X'X \widehat\beta + e'e
   $$
   $$
   = \widehat Y'\widehat Y - e'e
   $$
   $$
   (5) \sum_{i=1}^{n}(Y_{i} - \overline Y)^{2} = \sum_{i=1}^{n}(\widehat Y_{i} - \overline Y)^{2} + \sum_{i=1}^{n}e_{i}^{2}
   $$
   1. 調整済み決定係数
    $$
    R'^{2} = 1 - \frac{e'e/(n-k-1)}{Y'Y/(n-1)}
    $$
...
1. AR
   1. 時系列データの統計量
    例題8.1 時系列データ
      ...
      年・期          | 実質GDP(兆円)    | 実質成長率
      ----------      | -----            | -----     
      2005年1-3月期   | 531.30           | 3.4
      2005年4-6月期   | 536.78           | 4.2
      2005年7-9月期   | 539.96           | 2.4
      2005年10-12月期 | 541.93           | 1.5
      2006年1-3月期   | 543.08           | 0.8
      2006年4-6月期   | 547.63           | 3.4
      2006年7-9月期   | 549.76           | 1.6
      2006年10-12月期 | 553.55           | 2.8
      2007年1-3月期   | 559.83           | 4.6
      2007年4-6月期   | 559.74           | -0.1
      2007年7-9月期   | 560.59           | 0.6
      2007年10-12月期 | 564.22           | 2.6
      2008年1-3月期   | 566.39           | 1.5
      2008年4-6月期   | 563.21           | -2.2
      2008年7-9月期   | 559.15           | -2.9
      2008年10-12月期 | 539.21           | -13.5
      2009年1-3月期   | 518.95           | -14.2
   ...
   1. ARモデル
    ...
    例題8.2 ARモデル
     ...
     実行結果
     ```
     > source('chap8/RINT802.R', echo=TRUE)

     > gdp.ts = ts(start=2005,end=2009,frequency=4,c(531.30,536.78,539.96,541.93,534.08,547.63,549.76,553.55,559.83,559.74,560.59,564.22,566.39,563.21,559. .... [TRUNCATED] 
     ...
     Order selected 1  sigma^2 estimated as  127.6
     ...
     > ar(gdp.ts)$resid
                Qtr1       Qtr2       Qtr3       Qtr4
     2005         NA  -1.288092  -1.444794  -1.411055
     2006 -10.460563   7.869201   1.748780   4.241850
     2007   8.214168   4.300356   5.205156   8.317602
     2008   8.277342   3.776057   1.652318 -15.815600
     2009 -23.934390                                 

     > predict(ar(gdp.ts),n.ahead=10)
     $pred
              Qtr1     Qtr2     Qtr3     Qtr4
     2009          530.5483 537.6104 541.9104
     2010 544.5286 546.1228 547.0935 547.6846
     2011 548.0444 548.2636 548.3970         

     $se
              Qtr1     Qtr2     Qtr3     Qtr4
     2009          11.29707 13.22646 13.87376
     2010 14.10620 14.19141 14.22287 14.23452
     2011 14.23883 14.24043 14.24102         
     ```
...
1. ARIMA
   ...
   1. ARIMAモデル   
    例題8.3 ARIMAモデル
     ...
     実行結果
     ```
     > source('chap8/RINT803.R', echo=TRUE)
     ...
     Call:
     arima(x = gdp.ts, order = c(2, 2, 1))

     Coefficients:
              ar1     ar2      ma1
           0.4727  0.4134  -0.8614
     s.e.  0.7156  0.2733   0.7899

     sigma^2 estimated as 55.17:  log likelihood = -51.5,  aic = 111
     ...
     > jgdp$resid
                 Qtr1        Qtr2        Qtr3        Qtr4
     2005   0.2376046  -0.7005583  -2.0856698  -2.1103205
     2006 -10.0201980  17.8759553  -2.1537148  -3.6248615
     2007   3.3054933  -5.3832094  -1.7058668   3.4979986
     2008  -0.1519602  -5.9369325  -2.8582859 -15.7095505
     2009  -5.9777634                                    
     ...
     $pred
              Qtr1     Qtr2     Qtr3     Qtr4
     2009          497.1228 474.4225 450.6617
     2010 426.0386 400.5696 374.3442 347.4117
     2011 319.8322 291.6546 262.9269         

     $se
                Qtr1       Qtr2       Qtr3       Qtr4
     2009              7.428763  14.089018  23.032155
     2010  33.323291  45.151591  58.335900  72.868287
     2011  88.685900 105.758403 124.048472                
     ```   
...
1. GARCH
   ...
   1. 時系列用パッケージ
    ...
    例題8.4 GARCHモデル
     ...
     実行結果
     ```
     > source('chap8/RINT804.R', echo=TRUE)

     > library(tseries)

     > gdp.ts = ts(start=2005,end=2009,frequency=4,c(531.30,536.78,539.96,541.93,543.08,547.63,549.76,553.55,559.83,559.74,560.59,564.22,566.39,563.21,559. .... [TRUNCATED] 
      ...
      ***** ESTIMATION WITH ANALYTICAL GRADIENT ***** 
          ...
          1     1.986356e-04     1.000e+00
          2     5.000000e-02     1.000e+00
          3     5.000000e-02     1.000e+00

         IT   NF      F         RELDF    PRELDF    RELDX   STPPAR   D*STEP   NPRELDF
          0    1 -5.648e+01
          1    7 -5.658e+01  1.65e-03  2.21e-03  2.2e-04  2.6e+08  2.2e-05  2.92e+05
          2    8 -5.659e+01  2.38e-04  5.41e-04  2.1e-04  2.0e+00  2.2e-05  1.87e+00
          3    9 -5.660e+01  1.23e-04  1.29e-04  2.0e-04  2.0e+00  2.2e-05  1.77e+00
          4   10 -5.660e+01  5.87e-06  7.96e-06  2.2e-04  2.0e+00  2.2e-05  1.79e+00
          5   17 -5.742e+01  1.44e-02  2.20e-02  4.7e-01  2.0e+00  8.9e-02  1.76e+00
          6   19 -5.754e+01  2.04e-03  3.38e-03  3.2e-02  2.0e+00  8.9e-03  1.61e-02
          7   22 -5.759e+01  7.95e-04  7.72e-04  8.1e-02  1.4e+00  2.4e-02  1.08e-02
          8   24 -5.760e+01  1.67e-04  1.70e-04  1.6e-02  2.0e+00  4.7e-03  8.85e-03
          9   26 -5.761e+01  1.41e-04  1.41e-04  1.6e-02  1.8e+00  4.7e-03  8.63e-03
         10   28 -5.761e+01  2.42e-05  2.41e-05  3.2e-03  2.0e+00  9.4e-04  1.24e-02
         40   92 -5.762e+01  9.05e-10  9.05e-10  2.4e-08  7.3e+01  7.2e-09  1.39e-02
         41   94 -5.762e+01  1.79e-09  1.79e-09  4.8e-08  1.9e+01  1.4e-08  1.39e-02
         42   96 -5.762e+01  3.57e-10  3.57e-10  9.7e-09  2.6e+03  2.9e-09  1.39e-02
         43   99 -5.762e+01  2.85e-09  2.85e-09  7.8e-08  1.1e+02  2.3e-08  1.39e-02
         44  102 -5.762e+01  5.70e-11  5.70e-11  1.6e-09  3.7e+07  4.6e-10  1.39e-02
         45  104 -5.762e+01  1.14e-11  1.14e-11  3.1e-10  2.2e+08  9.2e-11  1.37e-02
         46  106 -5.762e+01  2.28e-11  2.28e-11  6.2e-10  2.8e+07  1.8e-10  1.37e-02
         47  108 -5.762e+01  4.56e-11  4.56e-11  1.2e-09  1.4e+07  3.7e-10  1.37e-02
         48  110 -5.762e+01  9.12e-12  9.12e-12  2.5e-10  2.9e+08  7.4e-11  1.37e-02
         49  112 -5.762e+01  1.82e-12  1.82e-12  5.0e-11  1.5e+09  1.5e-11  1.36e-02
         50  114 -5.762e+01  3.65e-13  3.65e-13  1.0e-11  7.4e+09  2.9e-12  1.36e-02
         51  116 -5.762e+01  7.30e-13  7.30e-13  2.0e-11  9.2e+08  5.9e-12  1.36e-02
         52  119 -5.762e+01  1.47e-14  1.46e-14  4.0e-13  1.8e+11  1.2e-13  1.36e-02
         53  122 -5.762e+01  1.17e-13  1.17e-13  3.2e-12  5.8e+09  9.4e-13  1.36e-02
         54  125 -5.762e+01  2.34e-15  2.33e-15  6.4e-14  1.2e+12  1.9e-14  1.36e-02
         55  127 -5.762e+01  4.69e-15  4.67e-15  1.3e-13  1.4e+11  3.8e-14  1.36e-02
         56  129 -5.762e+01  8.63e-16  9.34e-16  2.5e-14  2.9e+12  7.5e-15  1.37e-02
         57  131 -5.762e+01 -1.23e-16  1.87e-16  5.1e-15  1.4e+13  1.5e-15  1.35e-02

      ***** FALSE CONVERGENCE *****

      FUNCTION    -5.761830e+01   RELDX        5.068e-15
      FUNC. EVALS     131         GRAD. EVALS      57
      PRELDF       1.868e-16      NPRELDF      1.353e-02

          I      FINAL X(I)        D(I)          G(I)

          1    1.332870e-04     1.000e+00    -5.234e-03
          2    1.478601e-01     1.000e+00    -7.136e+00
          3    4.204712e-16     1.000e+00     2.313e-01


     > summary(jgdp2)

     Call:
     garch(x = diff(log(gdp.ts)), order = c(1, 1))
     ...
     Residuals:
         Min      1Q  Median      3Q     Max 
     -3.0578 -0.2484  0.3095  0.5212  0.9525 

     Coefficient(s):
         Estimate  Std. Error  t value Pr(>|t|)
     a0 1.333e-04   7.152e-04    0.186    0.852
     a1 1.479e-01   1.515e-01    0.976    0.329
     b1 4.205e-16   5.155e+00    0.000    1.000

     Diagnostic Tests:
     	Jarque Bera Test
     
     data:  Residuals
     X-squared = 9.6072, df = 2, p-value = 0.0082


     	Box-Ljung test

     data:  Squared.Residuals
     X-squared = 2.1129, df = 1, p-value = 0.1461     
     ```      
